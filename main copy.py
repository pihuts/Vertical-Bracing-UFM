...
try:
    ...
    bracing = MemberFactory.create_steelpy_member(section_class=aisc.L_shapes,section_name="L8X6X1", material=MATERIALS["a36"], shape_type="L",loading_condition=2)
    ...
    brace_gussetpl_connection = ConnectionFactory.create_bolted_connection(
        member_a=bracing,
    ...
    test_1 = BoltShearCalculator(brace_gussetpl_connection)
    test_1.calculate_capacity_fnt(number_of_shear_planes=1, debug="True")# fnt can only have 1 shear plane
    test_1.calculate_capacity_fnv(number_of_shear_planes=2,debug="True")

    test_2 =TensileYieldingCalculator(brace_gussetpl_connection.member_a,brace_gussetpl_connection)
    test_2.calculate_capacity(debug="True")


    test_3 = TensileRuptureCalculator(brace_gussetpl_connection.member_a,brace_gussetpl_connection)
    test_3.calculate_capacity(debug="True")
